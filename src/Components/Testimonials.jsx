...
import { AnimatedTooltip } from "../Utils/animated-tooltip.jsx"; 
import { cn } from "../Utils/utils.js"; 
import { AnimatedTestimonials } from "../Utils/animated-testimonials.jsx"; 
...
const testimonials = [
  ...
  },
  {
    ...
    name: "Jane Smith",
    designation: "Data Scientist",
    quote: "Great experience with this service.",
  },
];

export default function Testimonials() {
  return (
    <div className="items-center justify-center flex flex-col w-full p-15">
      <h1 className="text-4xl font-bold text-h1 mb-4">Testimonials</h1>
      <p className="text-gray-600 mb-8">What people have to say?</p>
